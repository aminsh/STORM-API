...
function rstr2hex(A) {
    ...
    for (var t = hexcase ? "0123456789ABCDEF" : "0123456789abcdef", o = "", i, s = 0; s < A.length; s++)i = A.charCodeAt(s), o += t.charAt(i >>> 4 & 15) + t.charAt(15 & i);
    return o
}
...
function StiJsViewer(A) {
    if (this.defaultParameters = {
            options: {
                reportGuid: "edabdd6c6cd24bfeb4b1e4f5e8358dc9",
                clientGuid: "7e821f22314343e6980dc0027ae5c813",
                ...
                productVersion: "2016.1.26 from 12 August 2016 ",
                email: {
                    showEmailDialog: !0,
                    defaultEmailMessage: "",
                    defaultEmailSubject: "",
                ...
                theme: "Office2013",
                requestAbsoluteUrl: "http://localhost:14618/Default.aspx"
            },
...
StiJsViewer.prototype.ShowAnimationVerticalMenu = function (A, e, t) {
    ...
    window.open("http://www.stimulsoft.com/" + e + "/documentation/online/" + A)
    ...
    this.options.appearance.scrollbarsMode = A || this.options.appearance.userScrollbarsMode, this.options.appearance.fullScreenMode = A, this.options.toolbar.visible && this.options.toolbar.showFullScreenButton && this.controls.toolbar.controls.FullScreen.setSelected(A), A ? (this.controls.viewer.style.position = "absolute", this.controls.viewer.style.userHeight = this.controls.viewer.style.height, this.controls.viewer.style.height = null, this.controls.reportPanel.style.position = "absolute", this.controls.reportPanel.style.top = this.options.toolbar.visible ? this.controls.toolbar.offsetHeight + "px" : 0, document.body.prevOverflow = document.body.style.overflow, document.body.style.overflow = "hidden") : (this.controls.viewer.style.position = "", this.controls.viewer.style.userHeight && (this.controls.viewer.style.height = this.controls.viewer.style.userHeight), this.controls.reportPanel.style.position = "Percentage" != this.options.viewerHeightType || this.options.appearance.scrollbarsMode ? "absolute" : "relative", this.controls.reportPanel.style.top = this.options.toolbar.visible && ("Percentage" != this.options.viewerHeightType || this.options.appearance.scrollbarsMode) ? this.controls.toolbar.offsetHeight + "px" : 0, "undefined" != typeof document.body.prevOverflow && (document.body.style.overflow = document.body.prevOverflow, delete document.body.prevOverflow)), this.controls.reportPanel.style.overflow = this.options.appearance.scrollbarsMode ? "auto" : "hidden"
    ...
    var A = [], e = [.25, .5, .75, 1, 1.25, 1.5, 2];
    for (var t in e)A.push(this.Item("item" + t, 100 * e[t] + "%", null, e[t].toString()));
    return A
    ...
    var A = [], e = ["10", "25", "50", "75", "100", "200", "300", "400", "500"];
    for (var t in e)A.push(this.Item("item" + t, e[t], null, e[t]));
    return A
    ...
    var A = [];
    for (var e in this.collections.encodingData) {
...
StiJsViewer.prototype.InitializeAboutPanel = function () {
    ...
    var A = ["root", "folder", "folderOpen", "node", "empty", "line", "join", "joinBottom", "plus", "plusBottom", "minus", "minusBottom"], e = {};
    for (var t in A)e[A[t]] = this.collections.images["Bookmarks" + A[t] + ".png"];
    ...
    i._io = !0, i._is = e, this.completed && i._hc && this.nodeStatus(!0, i._ai, i._ls), this.completed && e ? this.s(i._ai) : e && (this._sn = i._ai), this.openTo(i._p._ai, !1, !0)
    ...
    return this.length
}), Array.prototype.pop || (Array.prototype.pop = function e() {
    ...
    o.style.fontFamily = this.options.toolbar.fontFamily, "" != this.options.toolbar.fontColor && (o.style.color = this.options.toolbar.fontColor), o.jsObject = this, o.isEnabled = !0, o.isChecked = !1, o.id = this.generateKey(), o.name = A, o.captionText = e, t && o.setAttribute("title", t), o.className = "stiJsViewerCheckBox", A && (this.controls.checkBoxes || (this.controls.checkBoxes = {}), this.controls.checkBoxes[A] = o), o.imageBlock = document.createElement("div");
    var i = this.options.isTouchDevice ? "16px" : "13px";
    o.imageBlock.style.width = i, o.imageBlock.style.height = i, o.imageBlock.className = "stiJsViewerCheckBoxImageBlock";
    var s = o.addCell(o.imageBlock);
    this.options.isTouchDevice && (s.style.padding = "1px 3px 1px 1px"), o.image = document.createElement("img"), o.image.src = this.collections.images["CheckBox.png"], o.image.style.visibility = "hidden";
    ...
    o.style.margin = "2px 0 2px 0", o.className = "stiJsViewerDatePickerSeparator", e.innerContent.appendChild(o), e.daysTable = this.CreateHTMLTable(), e.innerContent.appendChild(e.daysTable);
    for (var i = 0; i < 7; i++) {
        ...
        n && (s.innerHTML = n.toString().substring(0, 1).toUpperCase()), 5 == i && (s.style.color = "#0000ff"), 6 == i && (s.style.color = "#ff0000")
    }
    e.daysTable.addRow();
    ...
    return p.style.width = "100%", p.style.textAlign = "right", e.time = h, h.action = function () {
        ...
        for (var A = this.key.getMonth(), e = this.key.getFullYear(), t = this.jsObject.GetCountDaysOfMonth(e, A), o = this.jsObject.GetDayOfWeek(e, A, 1), i = 0; i < 42; i++) {
            var s = i - (o - 1) + 1, n = s == this.key.getDate(), a = this.dayButtons[i];
            i < o - 1 || i - (o - 1) > t - 1 ? (a.caption.innerHTML = "", a.setEnabled(!1)) : (a.numberOfDay = s, a.caption.innerHTML = s, a.setEnabled(!0), a.setSelected(n))
        }
    }, e.fill = function () {
...
}, StiJsViewer.prototype.GroupPanel = function (A) {
    var e = document.createElement("fieldset");
    return e.style.fontFamily = this.options.toolbar.fontFamily, e.style.color = this.options.toolbarFontColor, e.caption = document.createElement("legend"), e.caption.className = "stiJsViewerGroupPanelCaption", e.caption.innerHTML = A, e.appendChild(e.caption), e.className = "stiJsViewerGroupPanel", e.container = document.createElement("div"), e.appendChild(e.container), e
    ...
    A.paintSortingArrow = function (A, e) {
        var t = this.jsObject.getPageFromAnchorElement(A), o = this.jsObject.FindPosX(A, "stiJsViewerReportPanel", !0), i = t ? this.jsObject.FindPosX(t, "stiJsViewerReportPanel", !0) : o, s = document.createElement("img");
        s.src = "asc" == e ? this.jsObject.collections.images["ArrowDown.png"] : this.jsObject.collections.images["ArrowUp.png"], s.style.position = "absolute";
        var n = this.jsObject.reportParams.zoom / 100 * 9, a = this.jsObject.reportParams.zoom / 100 * 5;
        s.style.width = n + "px", s.style.height = a + "px", s.style.marginLeft = n + "px", s.style.marginTop = a + "px", A.appendChild(s)
    }, A.paintCollapsingIcon = function (A, e) {
        var t = this.jsObject.getPageFromAnchorElement(A), o = this.jsObject.FindPosX(A, "stiJsViewerReportPanel", !0), i = t ? this.jsObject.FindPosX(t, "stiJsViewerReportPanel", !0) : o, s = document.createElement("img");
        s.src = e ? this.jsObject.collections.images["CollapsingPlus.png"] : this.jsObject.collections.images["CollapsingMinus.png"], s.style.position = "absolute";
        var n = this.jsObject.reportParams.zoom / 100 * 10, a = this.jsObject.reportParams.zoom / 100 * 10;
        s.style.width = n + "px", s.style.height = a + "px", A.appendChild(s)
        ...
        this.jsObject.reportParams.interactionCollapsingStates || (this.jsObject.reportParams.interactionCollapsingStates = {}), this.jsObject.reportParams.interactionCollapsingStates[e] || (this.jsObject.reportParams.interactionCollapsingStates[e] = {}), this.jsObject.reportParams.interactionCollapsingStates[e][t] = o;
        var i = {
            action: "Collapsing",
    ...
    var A = this.Progress();
    return A.jsObject = this, A.style.display = "none", this.controls.processImage = A, this.controls.mainPanel.appendChild(A), A.show = function () {
        this.style.display = "", this.jsObject.setObjectToCenter(this)
    }, A.hide = function () {
    ...
    i.style.height = this.options.isTouchDevice ? "26px" : "21px", i.style.lineHeight = i.style.height;
    var n = "stiJsViewerTextBox";
    return i.className = n + " " + n + "Default", A && (this.controls.textBoxes || (this.controls.textBoxes = {}), this.controls.textBoxes[A] = i), i.setEnabled = function (A) {
        this.isEnabled = A, this.disabled = !A, this.className = n + " " + n + (A ? "Default" : "Disabled")
    }, i.onmouseover = function () {
        this.jsObject.options.isTouchDevice || this.onmouseenter()
    }, i.onmouseenter = function () {
        if (!this.isEnabled || this.readOnly)return;
        this.isOver = !0, this.isSelected || this.isFocused || (this.className = n + " " + n + "Over")
    }, i.onmouseleave = function () {
        if (!this.isEnabled || this.readOnly)return;
        this.isOver = !1, this.isSelected || this.isFocused || (this.className = n + " " + n + "Default")
    }, i.setSelected = function (A) {
        this.isSelected = A, this.className = n + " " + n + (A ? "Over" : this.isEnabled ? this.isOver ? "Over" : "Default" : "Disabled")
    ...
    A.style.fontFamily = this.options.toolbar.fontFamily, "" != this.options.toolbar.fontColor && (A.style.color = this.options.toolbar.fontColor), A.style.fontSize = "12px", A.controls = {}, A.labels = {}, A.container.style.padding = "3px", A.addControlToParentControl = function (e, t, o, i) {
        null == o.innerTable && (o.innerTable = A.jsObject.CreateHTMLTable(), o.appendChild(o.innerTable)), t.parentRow = o.innerTable.addRow();
    ...
    for (var p = ["DocumentSecurityButton", "DigitalSignatureButton"], o = 0; o < p.length; o++) {
        ...
        g.innerTable.style.width = "100%", g.style.minWidth = "220px", g.caption.style.textAlign = "center", g.caption.style.width = "100%", g.style.display = "inline-block"
    }
    ...
    for (var m = ["SaveReportMdc", "SaveReportMdz", "SaveReportMdx"], o = 0; o < m.length; o++)A.controls[m[o]].controlName = m[o], A.controls[m[o]].onChecked = function () {
    ...
    for (var m = ["EmbeddedFonts", "UseUnicode"], o = 0; o < m.length; o++)A.controls[m[o]].onChecked = function () {
    ...
    A.controls.StandardPdfFonts.onChecked = function () {
        ...
        A.actionType = t, A.showControlsByExportFormat(e || "Pdf"), A.changeVisibleState(!0)
    }, A.action = function () {
        ...
        var e = {}, t = A.getExportControlNames();
        for (var o in t) {
        ...
        if ("Pdf" == A.exportFormat) {
            ...
            var r = ["PrintDocument", "ModifyContents", "CopyTextAndGraphics", "AddOrModifyTextAnnotations"];
            for (var o in r)e[r[o]] && ("" != e.UserAccessPrivileges && (e.UserAccessPrivileges += ", "), e.UserAccessPrivileges += r[o], delete e[r[o]])
        }
        A.jsObject.isContainted(t, "ImageType") && (e.ImageZoom = e.Zoom, delete e.Zoom);
        var r = [["ImageFormatForHtml", "ImageFormat"], ["EncodingTextOrCsvFile", "Encoding"], ["ExportModeRtf", "ExportMode"], ["EncodingDifFile", "Encoding"], ["EncodingDbfFile", "CodePage"]];
        for (var o in r)null != e[r[o][0]] && (e[r[o][1]] = e[r[o][0]], delete e[r[o][0]]);
        return e
    }
    ...
    for (var i = 0; i < t.length; i++) {
        var s = t[i][2];
        s.style.margin = "4px", e.controls[t[i][0]] = s, o.addTextCellInLastRow(t[i][1]).className = "stiJsViewerCaptionControls", o.addCellInLastRow(s), i < t.length - 1 && o.addRow()
    }
    e.show = function (A, e) {
    ...
    var A = [], e = ["25", "50", "75", "100", "150", "200"];
    for (var t in e)A.push(this.Item("Zoom" + e[t], e[t] + "%", "SelectedItem.png", "Zoom" + e[t]));
...
JSON.stringify = JSON.stringify || function (A) {
    ...
    0 != o.options.server.requestTimeout && setTimeout(function () {
        ...
        if (4 == i.readyState) {
            ...
            0 == A ? t("Error: Timeout response from the server", o) : 200 == A ? t(i.response, o) : t("Error: " + A + " - " + i.statusText, o)
        }
    };
    ...
    var t = window.open("about:blank", "PrintReport", "height=900, width=790, toolbar=no, menubar=yes, scrollbars=yes, resizable=yes, location=no, directories=no, status=no");
    ...
    var o = {
        ...
        exportFormat: A,
        exportSettings: e
    }, i = e.OpenAfterExport && "_blank" == this.options.appearance.openExportedReportTarget ? window.open("about:blank", "_blank").document : null, s = i ? this.options.requestAbsoluteUrl : this.options.requestUrl;
    ...
    var A = "_blank" == this.options.appearance.designTarget ? window.open("about:blank", "_blank").document : null, e = A ? this.options.requestAbsoluteUrl : this.options.requestUrl;
            ...
            return t.fillDialogInfoItems = function (e) {
                ...
                if (null != o && (o.is(Array) && (l = o), "object" == typeof o ? s = o : a = e.System.Convert.toString(o)), i.type == String)t.setVariable(r, o); else if (i.type == e.System.Single || i.type == e.System.Single) {
                    ...
                    try {
                        ...
                        e.System.StiError.showError(w, !1), p = e.System.DateTime.now
                    }
                    t.setVariable(r, p)
                    ...
                    try {
                        ...
                        e.System.StiError.showError(w, !1), p = e.System.TimeSpan.zero
                    }
                    t.setVariable(r, p)
                } else if (i.type == e.System.Guid || i.type == e.System.NullableGuid) {
                    var b = void 0;
                    try {
                        b = new e.System.Guid(a)
                    } catch (w) {
                        e.System.StiError.showError(w, !1), b = e.System.Guid.empty
                    }
                    t.setVariable(r, b)
                    ...
                    var x = 0, T = 0;
                    x = parseFloat(e.System.Convert.toString(s.from).replaceAll(",", n)), T = parseFloat(e.System.Convert.toString(s.to).replaceAll(",", n)), t.setVariable(r, new m(x, T))
                } else if (i.type == e.System.StimulsoftDoubleRange) {
                    var x = 0, T = 0;
                    x = parseFloat(e.System.Convert.toString(s.from).replaceAll(",", n)), T = parseFloat(e.System.Convert.toString(s.to).replaceAll(",", n)), t.setVariable(r, new y(x, T))
                } else if (i.type == e.System.StimulsoftDecimalRange) {
                    var x = 0, T = 0;
                    x = parseFloat(e.System.Convert.toString(s.from).replaceAll(",", n)), T = parseFloat(e.System.Convert.toString(s.to).replaceAll(",", n)), t.setVariable(r, new S(x, T))
                } else if (i.type == e.System.StimulsoftIntRange) {
                    var x = 0, T = 0;
                    x = parseInt(e.System.Convert.toString(s.from).replaceAll(",", n)), T = parseInt(e.System.Convert.toString(s.to).replaceAll(",", n)), t.setVariable(r, new v(x, T))
                } else if (i.type == e.System.StimulsoftShortRange) {
                    var x = 0, T = 0;
                    x = parseInt(e.System.Convert.toString(s.from).replaceAll(",", n)), T = parseInt(e.System.Convert.toString(s.to).replaceAll(",", n)), t.setVariable(r, new h(x, T))
                } else if (i.type == e.System.StimulsoftLongRange) {
                    var x = 0, T = 0;
                    x = parseInt(e.System.Convert.toString(s.from).replaceAll(",", n)), T = parseInt(e.System.Convert.toString(s.to).replaceAll(",", n)), t.setVariable(r, new A(x, T))
                } else if (i.type == e.System.StimulsoftByteRange) {
                    var x = 0, T = 0;
                    x = parseInt(e.System.Convert.toString(s.from).replaceAll(",", n)), T = parseInt(e.System.Convert.toString(s.to).replaceAll(",", n)), t.setVariable(r, new f(x, T))
                } else if (i.type == e.System.StimulsoftCharRange) {
                    var x = 0, T = 0;
                    x = e.System.Convert.toString(s.from), T = e.System.Convert.toString(s.to), t.setVariable(r, new u(x, T))
                } else if (i.type == e.System.StimulsoftDateTimeRange) {
                    var x = e.System.DateTime.now, T = e.System.DateTime.now;
                    x = new e.System.DateTime(Date.parse(s.from)), T = new e.System.DateTime(Date.parse(s.to)), t.setVariable(r, new d(x, T))
                } else if (i.type == e.System.StimulsoftTimeSpanRange) {
                    var x = e.System.TimeSpan.zero, T = e.System.TimeSpan.zero;
                    x = e.System.TimeSpan.fromString(s.from), T = e.System.TimeSpan.fromString(s.to), t.setVariable(r, new c(x, T))
                } else if (i.type == e.System.StimulsoftGuidRange) {
                    var x = e.System.Guid.empty, T = e.System.Guid.empty;
                    try {
                        x = new e.System.Guid(e.System.Convert.toString(s.from)), T = new e.System.Guid(e.System.Convert.toString(s.to))
                    } catch (w) {
                        e.System.StiError.showError(w, !1)
                    }
                    t.setVariable(r, new E(x, T))
                } else if (i.type == e.System.StimulsoftStringList) {
                    for (var P = [], I = 0, R = l; I < R.length; I++) {
                        var p = R[I];
                        P.add(p.toString())
                    }
                    t.setVariable(r, P), null != i.dialogInfo.keys && 0 != i.dialogInfo.keys.length || (i.dialogInfo.keys = P.toArray())
                    ...
                    for (var P = [], C = 0, D = l; C < D.length; C++) {
                        var p = D[C];
                        P.add(p.toNumber())
                    }
                    t.setVariable(r, P), null != i.dialogInfo.keys && 0 != i.dialogInfo.keys.length || (i.dialogInfo.keys = P.toArray().select(function (e) {
                        return e.toString()
                    }).toArray())
                } else if (i.type == e.System.StimulsoftIntList) {
                    for (var P = [], V = [], B = 0, k = l; B < k.length; B++) {
                        var p = k[B];
                        P.add(p.toNumber()), V.add(p.toString())
                    }
                    t.setVariable(r, P), null != i.dialogInfo.keys && 0 != i.dialogInfo.keys.length || (i.dialogInfo.keys = V)
                } else if (i.type == e.System.StimulsoftCharList) {
                    for (var P = [], F = 0, H = l; F < H.length; F++) {
                        var p = H[F];
                        P.add(p.toString())
                    }
                    t.setVariable(r, P), null != i.dialogInfo.keys && 0 != i.dialogInfo.keys.length || (i.dialogInfo.keys = P.toArray().select(function (e) {
                    ...
                    for (var P = [], M = 0, O = l; M < O.length; M++) {
                        var p = O[M];
                        P.add(p.toBoolean())
                    }
                    t.setVariable(r, P), null != i.dialogInfo.keys && 0 != i.dialogInfo.keys.length || (i.dialogInfo.keys = P.toArray().select(function (e) {
        ...
        var r = e.Report.Export.StiCsvExportSettings, o = e.Report.Export.StiCsvExportService, i = e.Report.Export.StiHtmlChartType, n = e.Report.Export.StiWord2007ExportService, a = e.Report.Export.StiWord2007ExportSettings, s = e.System.Drawing.ColorTranslator, l = e.System.IO.TextWriter, p = e.Report.Export.StiHtmlExportService, g = e.Report.Export.StiHtmlTextWriter, m = e.Report.Export.StiHtmlExportSettings, u = e.Report.StiPagesRange, d = e.Report.StiRangeType, c = e.Report.Export.StiHtmlExportMode, S = e.Report.Export.StiHtmlExportQuality, y = e.Report.Export.StiHtmlExportBookmarksMode, f = e.Base.Drawing.StiBrush, h = e.Report.StiExportFormat, v = e.Base.StiGZipHelper, A = e.Report.Export.StiPdfExportSettings, E = e.Report.Export.StiPdfExportService, w = e.System.IO.MemoryStream, b = e.Report.Export.StiExcel2007ExportService, x = e.Report.Export.StiExcelExportSettings, T = e.System.Promise, P = function () {
            ...
            return Object.defineProperty(P.prototype, "viewerId", {
                ...
                S.loc = t.StiCollectionsHelper.GetLocalizationItems(), this._jsObject = new StiJsViewer(S), this._jsObject.viewer = this, e.System.StiError.errorMessageForm = e.System.StiError.errorMessageForm || this.jsObject.controls.forms.errorMessageForm || this.jsObject.InitializeErrorMessageForm(), this.jsObject.assignReport = function (t) {
                    ...
                    }, e), "GetPages" != e.action && (r.pagesCount = 0, null != this.viewer.report && (r.reportGuid = this.viewer.report.reportGuid, r.isEditableReport = t.StiEditableFieldsHelper.checkEditableReport(this.viewer.report), r.pagesCount = this.viewer.report.renderedPages.count, r.reportFileName = this.viewer.getReportFileName(), r.interactionCollapsingStates = this.viewer.report.interactionCollapsingStates), r.paramsGuid = e.paramsGuid, r.drillDownGuid = e.drillDownGuid, r.zoom = e.zoom, r.viewMode = e.viewMode, "DrillDown" == e.action && (r.drillDownParameters = e.drillDownParameters)), r
                    ...
                    switch (d) {
                        ...
                        case h.Html5:
                            ...
                            var D = new p, H = new l, B = new g(H);
                            D.exportToAsync(function () {
                                var e = H.getStringBuilder().toString();
                        ...
                        case h.Pdf:
                            var I = new A;
                            t.StiExportsHelper.applyExportSettings(d, s, I);
                            var M = S.getReportFileName(), O = S.invokeBeginExportReport(I, d, M);
                            if (null != O) {
                            ...
                            D.exportToAsync(function () {
                                var e = j.toArray();
                                if (u == t.StiExportAction.SendEmail)return void S.invokeEmailReport(c, d, M, e);
                                if (O = S.invokeEndExportReport(d, M, e), null != O) {
                                    if (O.preventDefault)return;
                                    M = O.fileName
                                }
                                Object.saveAs(e, M + ".pdf", "application/pdf")
                            }, S.report, j, I);
                            break;
                        case h.Excel2007:
                            var I = new x;
                ...
                try {
                    ...
                    e.System.StiError.showError(n, !1), o.callCatch(n.message)
                }
                ...
                m.add(F);
                var H = o.getChartScript();
                return m.add(H), o.clear(), m
...
!function (e) {
    ...
    !function (t) {
        var r = e.System.Drawing.Color, o = function () {
            function e() {
                this.appearance = new t.StiAppearanceOptions, this.toolbar = new t.StiToolbarOptions, this.exports = new t.StiExportsOptions, this.width = "100%", this.height = String.empty, this.viewerId = String.empty, this.requestStylesUrl = String.empty, this.productVersion = "2016.2", this.actions = {
