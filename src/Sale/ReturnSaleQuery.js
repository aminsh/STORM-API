...
@injectable()
export class ReturnSaleQuery extends BaseQuery {
                ...
                this.select(
                    ...
                    .from(function () {
                        this.select('invoices.*',
                            ...
                            .leftJoin('detailAccounts as person', 'invoices.detailAccountId', 'person.id')
                            .modify(modify, branchId, userId, canView, 'invoices')
                            .andWhere('invoiceType', 'returnSale')
                            .as('base');
                    }).as("group")
                    .groupBy(
                        'createdAt',
    ...
    getCompareInvoiceOnChange(id, lines) {
        ...
        const compared = this.invoiceCompareService.compare('input', oldLines, newLines);
