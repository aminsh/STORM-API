...
require("./angular-aria"),module.exports="ngAria";

},{"./angular-aria":2}],4:[function(require,module,exports){
...
},{"./angular-cookies":4}],6:[function(require,module,exports){
...
"use strict";function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj}}Object.defineProperty(exports,"__esModule",{value:!0});var _angular=require("angular"),_angular2=_interopRequireDefault(_angular);require("angular-aria"),require("angular-messages"),require("angular-ui-router"),require("angular-translate"),require("angular-cookies"),require("adm-dtp");var _app=require("./app.route"),_app2=_interopRequireDefault(_app),_shell=require("./layout/shell"),_shell2=_interopRequireDefault(_shell),_app3=require("./app.translate"),_app4=_interopRequireDefault(_app3),_init=require("./authentication/init"),_init2=_interopRequireDefault(_init),_setDirty=require("./shared/setDirty"),_setDirty2=_interopRequireDefault(_setDirty),_promise=require("./shared/promise"),_promise2=_interopRequireDefault(_promise),_api=require("./shared/api"),_api2=_interopRequireDefault(_api),_logger=require("./shared/logger"),_logger2=_interopRequireDefault(_logger),_translate=require("./shared/translate"),_translate2=_interopRequireDefault(_translate),_home=require("./home/home.controller"),_home2=_interopRequireDefault(_home),_aboutus=require("./ourTeam/aboutus.controller"),_aboutus2=_interopRequireDefault(_aboutus),_pricing=require("./product/pricing.controller"),_pricing2=_interopRequireDefault(_pricing),_login=require("./authentication/login.controller"),_login2=_interopRequireDefault(_login),_register=require("./authentication/register.controller"),_register2=_interopRequireDefault(_register),_api3=require("./authentication/api.user"),_api4=_interopRequireDefault(_api3),_profile=require("./profile/profile.controller"),_profile2=_interopRequireDefault(_profile),_contactUs=require("./contactUs/contactUs.controller"),_contactUs2=_interopRequireDefault(_contactUs),_requestLucaDemo=require("./product/requestLucaDemo.controller"),_requestLucaDemo2=_interopRequireDefault(_requestLucaDemo),_setupInfo=require("./branch/setup-info"),_setupInfo2=_interopRequireDefault(_setupInfo),_setupFirstPeriod=require("./branch/setup-firstPeriod"),_setupFirstPeriod2=_interopRequireDefault(_setupFirstPeriod),_setupChartOfAccounts=require("./branch/setup-chartOfAccounts"),_setupChartOfAccounts2=_interopRequireDefault(_setupChartOfAccounts),_api5=require("./branch/api.branch"),_api6=_interopRequireDefault(_api5),_api7=require("./branch/api.fiscalPeriod"),_api8=_interopRequireDefault(_api7),_api9=require("./branch/api.chartOfAccount"),_api10=_interopRequireDefault(_api9),_logo=require("./branch/logo.upload"),_logo2=_interopRequireDefault(_logo);_angular2.default.module("app",["ngMessages","ui.router","pascalprecht.translate","ngCookies","ADM-dateTimePicker"]).config(_app2.default).config(_app4.default).config(function(ADMdtpProvider){ADMdtpProvider.setOptions({calType:"jalali",dtpType:"date",format:"YYYY/MM/DD",autoClose:!0})}).run(_init2.default).directive("shell",_shell2.default).factory("setDirty",_setDirty2.default).factory("translate",_translate2.default).service("Promise",_promise2.default).service("Api",_api2.default).service("logger",_logger2.default).controller("HomeController",_home2.default).controller("HomeController",_home2.default).controller("AboutUSController",_aboutus2.default).controller("PricingController",_pricing2.default).controller("LoginController",_login2.default).controller("RegisterController",_register2.default).service("userApi",_api4.default).controller("ProfileController",_profile2.default).controller("SetupInfoController",_setupInfo2.default).controller("SetupFirstPeriodController",_setupFirstPeriod2.default).controller("SetupChartOfAccountsController",_setupChartOfAccounts2.default).service("branchApi",_api6.default).service("fiscalPeriodApi",_api8.default).service("chartOfAccountApi",_api10.default).directive("logoUploader",_logo2.default).controller("ContactUsController",_contactUs2.default).controller("RequestLucaDemoController",_requestLucaDemo2.default),exports.default=_angular2.default.module("app");

},{"./app.route":26,"./app.translate":27,"./authentication/api.user":28,"./authentication/init":29,"./authentication/login.controller":30,"./authentication/register.controller":31,"./branch/api.branch":32,"./branch/api.chartOfAccount":33,"./branch/api.fiscalPeriod":34,"./branch/logo.upload":35,"./branch/setup-chartOfAccounts":36,"./branch/setup-firstPeriod":37,"./branch/setup-info":38,"./contactUs/contactUs.controller":39,"./home/home.controller":40,"./layout/shell":41,"./ourTeam/aboutus.controller":42,"./product/pricing.controller":43,"./product/requestLucaDemo.controller":44,"./profile/profile.controller":45,"./shared/api":46,"./shared/logger":47,"./shared/promise":48,"./shared/setDirty":49,"./shared/translate":50,"adm-dtp":1,"angular":11,"angular-aria":3,"angular-cookies":5,"angular-messages":7,"angular-translate":8,"angular-ui-router":9}],26:[function(require,module,exports){
"use strict";function routing($stateProvider,$urlRouterProvider,$locationProvider){$locationProvider.html5Mode({enabled:!0,requireBase:!1}),$locationProvider.hashPrefix("!"),$urlRouterProvider.otherwise("/page-not-found"),$stateProvider.state("home",{url:"/",onEnter:function($window){$window.location.href=$window.location.origin}}).state("aboutus",{url:"/about-us",templateUrl:"app/ourTeam/aboutus.html",controller:"AboutUSController",controllerAs:"VM"}).state("pricing",{url:"/product/pricing",templateUrl:"app/product/pricing.html",controller:"PricingController",controllerAs:"VM"}).state("order",{url:"/order/:plan",templateUrl:"app/product/order.html"}).state("login",{url:"/login",templateUrl:"app/authentication/login.html",controller:"LoginController",controllerAs:"login"}).state("register",{url:"/register",templateUrl:"app/authentication/register.html",controller:"RegisterController",controllerAs:"model"}).state("activateUser",{url:"/activate/:token",onEnter:function(logger,translate,$state){logger.success(translate("Your Account activated successfully")).then(function(){return $state.go("profile")})}}).state("profile",{url:"/profile",templateUrl:"app/profile/profile.html",controller:"ProfileController",controllerAs:"model",shouldAuthenticate:!0}).state("contactUs",{url:"/contact-us",templateUrl:"app/contactUs/contactUs.html",controller:"ContactUsController",controllerAs:"vm"}).state("setup",{url:"/setup",template:"<ui-view></ui-view>",shouldAuthenticate:!0}).state("setup.info",{url:"/info",templateUrl:"app/branch/setup-info.html",controller:"SetupInfoController",controllerAs:"model",shouldAuthenticate:!0}).state("setup.fiscalPeriod",{url:"/first-fiscal-period",templateUrl:"app/branch/setup-firstFiscalPeriod.html",controller:"SetupFirstPeriodController",controllerAs:"model",shouldAuthenticate:!0}).state("setup.chartOfAccounts",{url:"/chart-of-accounts",templateUrl:"app/branch/setup-chartOfAccounts.html",controller:"SetupChartOfAccountsController",controllerAs:"model",shouldAuthenticate:!0}).state("/page-not-found",{template:"<h1>Page not found</h1>"})}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=routing,routing.$inject=["$stateProvider","$urlRouterProvider","$locationProvider"];

},{}],27:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=function($translateProvider){var translate=JSON.parse(localStorage.getItem("translate"));$translateProvider.translations("fa_IR",translate),$translateProvider.preferredLanguage("fa_IR"),$translateProvider.useSanitizeValueStrategy("escapeParameters")};

},{}],28:[function(require,module,exports){
"use strict";function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||!1,descriptor.configurable=!0,"value"in descriptor&&(descriptor.writable=!0),Object.defineProperty(target,descriptor.key,descriptor)}}return function(Constructor,protoProps,staticProps){return protoProps&&defineProperties(Constructor.prototype,protoProps),staticProps&&defineProperties(Constructor,staticProps),Constructor}}(),UserApi=function(){function UserApi(Api){_classCallCheck(this,UserApi),this.Api=Api,this.prefixUrl="/api/users"}return _createClass(UserApi,[{key:"login",value:function(data){return this.Api.post("/api/auth/login",data)}},{key:"logout",value:function(){return this.Api.post("api/auth/logout")}},{key:"register",value:function(data){return this.Api.post(this.prefixUrl+"/register",data)}},{key:"isUniqueEmail",value:function(email){return this.Api.get(this.prefixUrl+"/is-unique-email/"+email)}},{key:"getByEmail",value:function(email){return this.Api.get(this.prefixUrl+"/by-email/"+email)}},{key:"getAuthReturnUrl",value:function(){return this.Api.get(this.prefixUrl+"/return-url")}}]),UserApi}();exports.default=UserApi,UserApi.$inject=["Api"];

},{}],29:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=function($rootScope,$location,$state){var locationSearch=!1;$rootScope.$on("$stateChangeStart",function(event,toState,toParams,fromState,fromParams){toState.shouldAuthenticate&&!$rootScope.isAuthenticated&&(event.preventDefault(),$location.search({returnUrl:$location.$$url}),$state.go("login"))}),$rootScope.$on("$stateChangeStart",function(){return locationSearch=$location.search()}),$rootScope.$on("$stateChangeSuccess",function(){return $location.search(locationSearch)})};

},{}],30:[function(require,module,exports){
"use strict";function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||!1,descriptor.configurable=!0,"value"in descriptor&&(descriptor.writable=!0),Object.defineProperty(target,descriptor.key,descriptor)}}return function(Constructor,protoProps,staticProps){return protoProps&&defineProperties(Constructor.prototype,protoProps),staticProps&&defineProperties(Constructor,staticProps),Constructor}}(),LoginController=function(){function LoginController(userApi,setDirty,$rootScope,$scope,$state,$location,$window,$cookies){_classCallCheck(this,LoginController),$rootScope.noFooter=!0,$scope.$on("$destroy",function(){$rootScope.noFooter=!1}),this.userApi=userApi,this.$rootScope=$rootScope,this.$state=$state,this.setDirty=setDirty,this.isError=!1,this.user={email:"",password:""},this.$cookies=$cookies,this.$window=$window,this.returnUrl=$location.search().returnUrl,this.returnUrl&&$cookies.put("return-url",this.returnUrl)}return _createClass(LoginController,[{key:"login",value:function(form){var _this=this;if(form.$invalid)return this.setDirty(form);this.userApi.login(this.user).then(function(result){_this.returnUrl?_this.$window.location=_this.returnUrl:(_this.$rootScope.currentUser=result.currentUser,_this.$rootScope.isAuthenticated=!0,_this.$state.go("profile"))}).catch(function(err){return _this.isError=!0})}},{key:"loginByGoogle",value:function(){var url=this.$window.location.origin+"/auth/google";this.$window.open(url,"_self")}}]),LoginController}();exports.default=LoginController,LoginController.$inject=["userApi","setDirty","$rootScope","$scope","$state","$location","$window","$cookies"];

},{}],31:[function(require,module,exports){
"use strict";function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||!1,descriptor.configurable=!0,"value"in descriptor&&(descriptor.writable=!0),Object.defineProperty(target,descriptor.key,descriptor)}}return function(Constructor,protoProps,staticProps){return protoProps&&defineProperties(Constructor.prototype,protoProps),staticProps&&defineProperties(Constructor,staticProps),Constructor}}(),RegisterController=function(){function RegisterController(userApi,setDirty,$rootScope,$scope,$state,logger,translate,$timeout){_classCallCheck(this,RegisterController),$rootScope.noFooter=!0,$scope.$on("$destroy",function(){$rootScope.noFooter=!1}),this.userApi=userApi,this.$rootScope=$rootScope,this.$state=$state,this.logger=logger,this.translate=translate,this.$timeout=$timeout,this.setDirty=setDirty,this.isError=!1,this.user={email:"",password:""},this.canShowForm=!0}return _createClass(RegisterController,[{key:"check",value:function(form){var email=this.user.email;if(""===email)return!0;this.userApi.isUniqueEmail(email).then(function(isValid){!0===isValid?(form.email.$invalid=!0,form.email.$error.check=!0,form.email.$dirty=!0):(form.email.$error.check=!1,form.email.$dirty=!1,form.email.$invalid=!1)})}},{key:"register",value:function(form){var _this=this,user=this.user,translate=this.translate;return form.$invalid?this.setDirty(form):user.password!==user.confirmPassword?(form.confirmPassword.$error.match=!0,this.setDirty(form)):!0===form.email.$error.check?this.setDirty(form):void this.userApi.register(user).then(function(result){_this.canShowForm=!1,_this.$timeout(function(){_this.logger.success(translate("Your registration has been done successfully"),translate("For activation your account , check your Email")).then(function(){return _this.$state.go("home")})})})}}]),RegisterController}();exports.default=RegisterController,RegisterController.$inject=["userApi","setDirty","$rootScope","$scope","$state","logger","translate","$timeout"];

},{}],32:[function(require,module,exports){
"use strict";function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||!1,descriptor.configurable=!0,"value"in descriptor&&(descriptor.writable=!0),Object.defineProperty(target,descriptor.key,descriptor)}}return function(Constructor,protoProps,staticProps){return protoProps&&defineProperties(Constructor.prototype,protoProps),staticProps&&defineProperties(Constructor,staticProps),Constructor}}(),BranchApi=function(){function BranchApi(Api){_classCallCheck(this,BranchApi),this.Api=Api,this.prefixUrl="/api/branches"}return _createClass(BranchApi,[{key:"create",value:function(data){return this.Api.post(""+this.prefixUrl,data)}},{key:"getMyBranches",value:function(){return this.Api.get(this.prefixUrl+"/my")}}]),BranchApi}();exports.default=BranchApi,BranchApi.$inject=["Api"];

},{}],33:[function(require,module,exports){
"use strict";function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||!1,descriptor.configurable=!0,"value"in descriptor&&(descriptor.writable=!0),Object.defineProperty(target,descriptor.key,descriptor)}}return function(Constructor,protoProps,staticProps){return protoProps&&defineProperties(Constructor.prototype,protoProps),staticProps&&defineProperties(Constructor,staticProps),Constructor}}(),ChartOfAccountApi=function(){function ChartOfAccountApi(Api){_classCallCheck(this,ChartOfAccountApi),this.Api=Api,this.prefixUrl="/acc/api/general-ledger-accounts"}return _createClass(ChartOfAccountApi,[{key:"get",value:function(){return this.Api.get(this.prefixUrl+"/default/chart-of-accounts")}}]),ChartOfAccountApi}();exports.default=ChartOfAccountApi,ChartOfAccountApi.$inject=["Api"];

},{}],34:[function(require,module,exports){
"use strict";function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||!1,descriptor.configurable=!0,"value"in descriptor&&(descriptor.writable=!0),Object.defineProperty(target,descriptor.key,descriptor)}}return function(Constructor,protoProps,staticProps){return protoProps&&defineProperties(Constructor.prototype,protoProps),staticProps&&defineProperties(Constructor,staticProps),Constructor}}(),FiscalPeriodApi=function(){function FiscalPeriodApi(Api){_classCallCheck(this,FiscalPeriodApi),this.Api=Api,this.prefixUrl="/acc/api/fiscal-periods"}return _createClass(FiscalPeriodApi,[{key:"create",value:function(data){return this.Api.post(""+this.prefixUrl,data)}}]),FiscalPeriodApi}();exports.default=FiscalPeriodApi,FiscalPeriodApi.$inject=["Api"];

},{}],35:[function(require,module,exports){
"use strict";function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj}}function uploader(){return{restrict:"E",template:'<form action="#" class="dropzone dz-clickable" id="upload">\n\n    <div class="dz-default dz-message"><span>\n        <strong>برای آپلود لوگو فایل خود را به این قسمت بکشید یا همینجا کلیک کنید</strong>\n    </span>\n    </div>\n</form>',replace:!0,scope:{before:"&",uploaded:"&"},link:function(scope,element,attrs){var config={url:"/upload",method:"post",maxFilesize:2,clickable:"#upload"},dropzone=new _dropzone2.default(element[0],config);dropzone.on("success",function(file,response){scope.uploaded({fileName:response.fullName}),scope.$apply()}),dropzone.on("error",function(error){console.log(error)})}}}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=uploader;var _dropzone=require("dropzone"),_dropzone2=_interopRequireDefault(_dropzone);

},{"dropzone":12}],36:[function(require,module,exports){
"use strict";function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||!1,descriptor.configurable=!0,"value"in descriptor&&(descriptor.writable=!0),Object.defineProperty(target,descriptor.key,descriptor)}}return function(Constructor,protoProps,staticProps){return protoProps&&defineProperties(Constructor.prototype,protoProps),staticProps&&defineProperties(Constructor,staticProps),Constructor}}(),SetupChartOfAccounts=function(){function SetupChartOfAccounts(chartOfAccountApi){var _this=this;_classCallCheck(this,SetupChartOfAccounts),this.accounts=[],chartOfAccountApi.get().then(function(result){return _this.accounts=result})}return _createClass(SetupChartOfAccounts,[{key:"save",value:function(form){}}]),SetupChartOfAccounts}();exports.default=SetupChartOfAccounts,SetupChartOfAccounts.$inject=["chartOfAccountApi"];

},{}],37:[function(require,module,exports){
"use strict";function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj}}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||!1,descriptor.configurable=!0,"value"in descriptor&&(descriptor.writable=!0),Object.defineProperty(target,descriptor.key,descriptor)}}return function(Constructor,protoProps,staticProps){return protoProps&&defineProperties(Constructor.prototype,protoProps),staticProps&&defineProperties(Constructor,staticProps),Constructor}}(),_momentJalaali=require("moment-jalaali"),_momentJalaali2=_interopRequireDefault(_momentJalaali),SetupFirstPeriodController=function(){function SetupFirstPeriodController(fiscalPeriodApi,$state,setDirty){_classCallCheck(this,SetupFirstPeriodController),this.fiscalPeriodApi=fiscalPeriodApi,this.$state=$state,this.setDirty=setDirty;var date=(0,_momentJalaali2.default)(),year=date.jYear(),isLeap=_momentJalaali2.default.jIsLeapYear(year),maxDate=year+"/12/"+(isLeap?"30":"29");this.fiscalPeriod={title:"سال مالی منتهی به "+maxDate,minDate:year+"/01/01",maxDate:year+"/12/"+(isLeap?"30":"29")}}return _createClass(SetupFirstPeriodController,[{key:"save",value:function(form){var _this=this;if(form.$invalid)return this.setDirty(form);this.fiscalPeriodApi.create(this.fiscalPeriod).then(function(){_this.$state.go("^.chartOfAccount")})}}]),SetupFirstPeriodController}();exports.default=SetupFirstPeriodController,SetupFirstPeriodController.$inject=["fiscalPeriodApi","$state","setDirty"];

},{"moment-jalaali":14}],38:[function(require,module,exports){
"use strict";function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||!1,descriptor.configurable=!0,"value"in descriptor&&(descriptor.writable=!0),Object.defineProperty(target,descriptor.key,descriptor)}}return function(Constructor,protoProps,staticProps){return protoProps&&defineProperties(Constructor.prototype,protoProps),staticProps&&defineProperties(Constructor,staticProps),Constructor}}(),SetupInfoController=function(){function SetupInfoController(branchApi,setDirty,$state){_classCallCheck(this,SetupInfoController),this.branchApi=branchApi,this.setDirty=setDirty,this.$state=$state,this.isWaiting=!1,this.branch={name:"",logo:"",phone:"",address:"",registrationNumber:""}}return _createClass(SetupInfoController,[{key:"save",value:function(form){var _this=this;if(form.$invalid)return this.setDirty(form);this.isWaiting=!0,this.branchApi.create(this.branch).then(function(result){_this.$state.go("^.fiscalPeriod")}).finally(function(){return _this.isWaiting=!1})}},{key:"logoUploaded",value:function(fileName){this.branch.logo=fileName}}]),SetupInfoController}();exports.default=SetupInfoController,SetupInfoController.$inject=["branchApi","setDirty","$state"];

},{}],39:[function(require,module,exports){
"use strict";function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||!1,descriptor.configurable=!0,"value"in descriptor&&(descriptor.writable=!0),Object.defineProperty(target,descriptor.key,descriptor)}}return function(Constructor,protoProps,staticProps){return protoProps&&defineProperties(Constructor.prototype,protoProps),staticProps&&defineProperties(Constructor,staticProps),Constructor}}(),ContactUs=function(){function ContactUs($http,setDirty){_classCallCheck(this,ContactUs),this.contactUsModel={name:"",email:"",phone:"",message:""},this.$http=$http,this.setDirty=setDirty,this.result={isValid:!1}}return _createClass(ContactUs,[{key:"send",value:function(form){var _this=this;if(form.$invalid)return this.setDirty(form);this.$http.post("/api/send-message",this.contactUsModel).then(function(result){return _this.result=result.data})}}]),ContactUs}();exports.default=ContactUs,ContactUs.$inject=["$http","setDirty"];

},{}],40:[function(require,module,exports){
"use strict";function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||!1,descriptor.configurable=!0,"value"in descriptor&&(descriptor.writable=!0),Object.defineProperty(target,descriptor.key,descriptor)}}return function(Constructor,protoProps,staticProps){return protoProps&&defineProperties(Constructor.prototype,protoProps),staticProps&&defineProperties(Constructor,staticProps),Constructor}}(),HomeController=function(){function HomeController($window){_classCallCheck(this,HomeController);this.prices=[{name:"رایگان",cost:"۰ هزار تومان",features:["تک کاربره","امنیت پایین","نسخه پشتیبان ندارد","حد اکثر 1000 سند حسابداری"]},{name:"اقتصادی",cost:"50.000 تومان (ماهیانه)",features:["2 کاربره","امنیت بالاتر نسبت به طرح رایگان","نسخه پشتبان هر 24 ساعت","حجم دیتابیس 500 مگابایت"]},{name:"حرفه ای",cost:"200.000 تومان (ماهیانه)",features:["5 کاربره","رمز نگاری از اطلاعات حساس","نسخه پشتبان هر 12 ساعت ","حجم دیتابیس 2 گیگابایت"]},{name:"سرور اختصاصی ",cost:"تماس بگیرید",features:["دامین اختصاصی","کابران نامحدود","حجم دیتابیس نامحدود","نسخه پشتبان هر 12 ساعت "]}],this.$window=$window}return _createClass(HomeController,[{key:"goToStorm",value:function(){this.$window.location.href=this.$window.location.origin+"/acc"}}]),HomeController}();exports.default=HomeController,HomeController.inject=["$window"];

},{}],41:[function(require,module,exports){
"use strict";function shell($rootScope,$window){return{restrict:"E",templateUrl:"app/layout/shell.html",link:function(scope,element,attrs){scope.toggleSidenav=function(){return $mdSidenav("right").toggle()};var currentUser=$window.document.getElementsByName("currentUser")[0].content;currentUser?(scope.currentUser=currentUser,scope.currentUserImage=$window.document.getElementsByName("currentUserImage")[0].content,scope.logined=!0,$rootScope.isAuthenticated=!0):(currentUser=$rootScope.currentUser)&&(scope.currentUser=currentUser,scope.logined=!0,$rootScope.isAuthenticated=!0),scope.logout=function(){return $window.href=$window.origin+"/logout"}}}}Object.defineProperty(exports,"__esModule",{value:!0}),shell.$inject=["$rootScope","$window"],exports.default=shell;

},{}],42:[function(require,module,exports){
"use strict";function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var AboutUSController=function AboutUSController(){_classCallCheck(this,AboutUSController),this.teams=[{name:"امین شیخی",img:"/public/images/amin.jpg",position:"بنیانگذار و مدیر فنی",degree:"مهندسی IT گرایش تجارت الکترونیک",desc:"با سابقه ی 7سال در زمینه نرم افزارهای مالی و حسابداری، پیشرو و بروز در زمینه ی تکنولوژی های نرم افزاری",linkedin:"https://www.linkedin.com/in/amin-sheikhi-29833050/"},{name:"ساناز سلیمانی",img:"/public/images/sanaz2.jpg",position:"بنیانگذار و مدیر محصول",degree:"مهندسی نرم افزار",desc:"با سابقه ی 2 سال در زمینه ی نرم افزارهای مالی و حسابداری، همچنین 3سال متخصص در زمینه ی هوش تجاری، گزارشات و داشبورد در صنعت بیمه",linkedin:"https://www.linkedin.com/in/sanaz-soleimani-b37616ab/"},{name:"علیرضا آقازاده",img:"/public/images/alireza.jpg",position:"مشاور مالی نرم افزار",degree:"کارشناسی مالی و حسابداری",desc:"مدیر مالی چندین شرکت معتبر در صنعت برق بوده و اکنون مشاور مالی  چندین شرکت می باشد.",linkedin:""},{name:"آذین امینی",img:"/public/images/Azin_Amini2.jpg",position:"کارشناس تست نرم افزار",degree:"مهندسی شیمی",desc:"با سابقه ی تدریس و کمک حسابداری در شرکت مالی و حسابداری",linkedin:""}]};exports.default=AboutUSController;

},{}],43:[function(require,module,exports){
"use strict";function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var PricingController=function PricingController($stateParams,$sce,$rootScope){_classCallCheck(this,PricingController),$rootScope.noFooter=!0,this.pricelist=[{key:"economy",name:"اقتصادی",cost:"50.000 تومان / ماهیانه",features:["2 کاربره","دامنه اختصاصی ندارد","پشتیبانی مالی ندارد"],suggest:!1,color:"green"},{key:"professional",name:"حرفه ای",cost:"200.000 تومان / ماهیانه",features:["تعداد کاربر نامحدود","دامنه اختصاصی ندارد","پشتیبانی مالی دارد"],suggest:!0,color:"cyan"},{key:"dedicated",name:"سرور اختصاصی ",cost:"تماس بگیرید",features:["دامنه اختصاصی","کابران نامحدود","پشتیبانی مالی دارد"],suggest:!1,color:"blue"}]};exports.default=PricingController,PricingController.$inject=["$stateParams","$sce","$rootScope"];

},{}],44:[function(require,module,exports){
"use strict";function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||!1,descriptor.configurable=!0,"value"in descriptor&&(descriptor.writable=!0),Object.defineProperty(target,descriptor.key,descriptor)}}return function(Constructor,protoProps,staticProps){return protoProps&&defineProperties(Constructor.prototype,protoProps),staticProps&&defineProperties(Constructor,staticProps),Constructor}}(),RequestLucaDemo=function(){function RequestLucaDemo($http,setDirty){_classCallCheck(this,RequestLucaDemo),this.model={name:"",email:""},this.$http=$http,this.setDirty=setDirty,this.result={isValid:!1}}return _createClass(RequestLucaDemo,[{key:"send",value:function(form){var _this=this;if(form.$invalid)return this.setDirty(form);this.$http.post("/api/request-accounting-demo",this.model).then(function(result){return _this.result=result.data})}}]),RequestLucaDemo}();exports.default=RequestLucaDemo,RequestLucaDemo.$inject=["$http","setDirty"];

},{}],45:[function(require,module,exports){
"use strict";function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||!1,descriptor.configurable=!0,"value"in descriptor&&(descriptor.writable=!0),Object.defineProperty(target,descriptor.key,descriptor)}}return function(Constructor,protoProps,staticProps){return protoProps&&defineProperties(Constructor.prototype,protoProps),staticProps&&defineProperties(Constructor,staticProps),Constructor}}(),ProfileController=function(){function ProfileController(branchApi,$window,$cookies){var _this=this;_classCallCheck(this,ProfileController),this.$window=$window,this.$cookies=$cookies,branchApi.getMyBranches().then(function(result){_this.branches=result})}return _createClass(ProfileController,[{key:"select",value:function(branch){this.$cookies.put("branch-id",branch.id,{path:"/"});var url=this.$window.location.origin+"/acc";this.$window.open(url,"_self")}}]),ProfileController}();exports.default=ProfileController,ProfileController.$nject=["branchApi","$window","$cookies"];

},{}],46:[function(require,module,exports){
"use strict";function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||!1,descriptor.configurable=!0,"value"in descriptor&&(descriptor.writable=!0),Object.defineProperty(target,descriptor.key,descriptor)}}return function(Constructor,protoProps,staticProps){return protoProps&&defineProperties(Constructor.prototype,protoProps),staticProps&&defineProperties(Constructor,staticProps),Constructor}}(),Api=function(){function Api(Promise,$http){_classCallCheck(this,Api),this.Promise=Promise,this.$http=$http}return _createClass(Api,[{key:"get",value:function(url,data){var _this=this;return this.Promise.create(function(resolve,reject){_this.$http.get(url,{params:data,paramSerializer:"$httpParamSerializerJQLike"}).then(function(result){resolve(result.data)}).catch(function(error){console.error(error),reject(["Internal Error"])})})}},{key:"post",value:function(url,data){return this.createWriteRequest(this.$http.post(url,data))}},{key:"put",value:function(url,data){return this.createWriteRequest(this.$http.put(url,data))}},{key:"delete",value:function(url,data){return this.createWriteRequest(this.$http.delete(url,data))}},{key:"createWriteRequest",value:function(promise){return this.Promise.create(function(resolve,reject){promise.then(function(data){var result=data.data;result.isValid?resolve(result.returnValue):reject(result.errors)}).catch(function(error){console.error(error),reject(["Internal Error"])})})}}]),Api}();exports.default=Api,Api.$inject=["Promise","$http"];

},{}],47:[function(require,module,exports){
"use strict";function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj}}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||!1,descriptor.configurable=!0,"value"in descriptor&&(descriptor.writable=!0),Object.defineProperty(target,descriptor.key,descriptor)}}return function(Constructor,protoProps,staticProps){return protoProps&&defineProperties(Constructor.prototype,protoProps),staticProps&&defineProperties(Constructor,staticProps),Constructor}}(),_sweetalert=require("sweetalert"),_sweetalert2=_interopRequireDefault(_sweetalert),Logger=function(){function Logger(translate,Promise){_classCallCheck(this,Logger),this.translate=translate,this.Promise=Promise}return _createClass(Logger,[{key:"success",value:function(title,message){var _this=this;return this.Promise.create(function(resolve,reject){var translate=_this.translate;(0,_sweetalert2.default)({title:title,text:message,type:"success",confirmButtonText:translate("OK")},function(){resolve()})})}},{key:"info",value:function(message){var translate=this.translate;(0,_sweetalert2.default)({title:translate("Info"),text:message,type:"info",timer:2e3,confirmButtonText:translate("OK")})}},{key:"warning",value:function(message){var translate=this.translate;(0,_sweetalert2.default)({title:translate("Warning"),text:message,type:"warning",timer:2e3,confirmButtonText:translate("OK")})}},{key:"error",value:function(message){var translate=this.translate;(0,_sweetalert2.default)({title:translate("Error"),text:message,type:"error",timer:4e3,confirmButtonText:translate("OK")})}}]),Logger}();exports.default=Logger,Logger.$inject=["translate","Promise"];

},{"sweetalert":24}],48:[function(require,module,exports){
"use strict";function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||!1,descriptor.configurable=!0,"value"in descriptor&&(descriptor.writable=!0),Object.defineProperty(target,descriptor.key,descriptor)}}return function(Constructor,protoProps,staticProps){return protoProps&&defineProperties(Constructor.prototype,protoProps),staticProps&&defineProperties(Constructor,staticProps),Constructor}}(),Promise=function(){function Promise($q){_classCallCheck(this,Promise),this.$q=$q}return _createClass(Promise,[{key:"create",value:function(handler){var deferred=this.$q.defer();return handler(deferred.resolve,deferred.reject),deferred.promise}}]),Promise}();exports.default=Promise,Promise.$inject=["$q"];

},{}],49:[function(require,module,exports){
"use strict";function setDirty(){return function(form){return angular.forEach(form.$error,function(type){angular.forEach(type,function(field){field.$setDirty()})}),form}}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=setDirty;

},{}],50:[function(require,module,exports){
"use strict";function translate($filter){return function(key){return $filter("translate")(key)}}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=translate;

},{}]},{},[25])
//# sourceMappingURL=storm.bundle.min.map
