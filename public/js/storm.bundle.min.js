...
"use strict";function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj}}Object.defineProperty(exports,"__esModule",{value:!0});var _angular=require("angular"),_angular2=_interopRequireDefault(_angular);require("angular-aria"),require("angular-material"),require("angular-messages"),require("angular-ui-router");var _app=require("./app.route"),_app2=_interopRequireDefault(_app),_shell=require("./layout/shell"),_shell2=_interopRequireDefault(_shell),_setDirty=require("./shared/setDirty"),_setDirty2=_interopRequireDefault(_setDirty),_promise=require("./shared/promise"),_promise2=_interopRequireDefault(_promise),_api=require("./shared/api"),_api2=_interopRequireDefault(_api),_home=require("./home/home.controller"),_home2=_interopRequireDefault(_home),_aboutus=require("./ourTeam/aboutus.controller"),_aboutus2=_interopRequireDefault(_aboutus),_pricing=require("./product/pricing.controller"),_pricing2=_interopRequireDefault(_pricing),_login=require("./authentication/login.controller"),_login2=_interopRequireDefault(_login),_register=require("./authentication/register.controller"),_register2=_interopRequireDefault(_register),_api3=require("./authentication/api.user"),_api4=_interopRequireDefault(_api3),_contactUs=require("./contactUs/contactUs.controller"),_contactUs2=_interopRequireDefault(_contactUs),_requestLucaDemo=require("./product/requestLucaDemo.controller"),_requestLucaDemo2=_interopRequireDefault(_requestLucaDemo);_angular2.default.module("app",["ngMaterial","ngMessages","ui.router"]).config(_app2.default).directive("shell",_shell2.default).factory("setDirty",_setDirty2.default).service("Promise",_promise2.default).service("Api",_api2.default).controller("HomeController",_home2.default).controller("HomeController",_home2.default).controller("AboutUSController",_aboutus2.default).controller("PricingController",_pricing2.default).controller("LoginController",_login2.default).controller("RegisterController",_register2.default).service("userApi",_api4.default).controller("ContactUsController",_contactUs2.default).controller("RequestLucaDemoController",_requestLucaDemo2.default),exports.default=_angular2.default.module("app");

},{"./app.route":13,"./authentication/api.user":14,"./authentication/login.controller":15,"./authentication/register.controller":16,"./contactUs/contactUs.controller":17,"./home/home.controller":18,"./layout/shell":19,"./ourTeam/aboutus.controller":20,"./product/pricing.controller":21,"./product/requestLucaDemo.controller":22,"./shared/api":23,"./shared/promise":24,"./shared/setDirty":25,"angular":11,"angular-aria":4,"angular-material":6,"angular-messages":8,"angular-ui-router":9}],13:[function(require,module,exports){
"use strict";function routing($stateProvider,$urlRouterProvider,$locationProvider){$locationProvider.html5Mode({enabled:!0,requireBase:!1}),$locationProvider.hashPrefix("!"),$urlRouterProvider.otherwise("/page-not-found"),$stateProvider.state("home",{url:"/",templateUrl:"app/home/home.html",controller:"HomeController",controllerAs:"home"}).state("aboutus",{url:"/about-us",templateUrl:"app/ourTeam/aboutus.html",controller:"AboutUSController",controllerAs:"VM"}).state("pricing",{url:"/product/:type/pricing",templateUrl:"app/product/pricing.html",controller:"PricingController",controllerAs:"VM"}).state("login",{url:"/login",templateUrl:"app/authentication/login.html",controller:"LoginController",controllerAs:"login"}).state("register",{url:"/register",templateUrl:"app/authentication/register.html",controller:"RegisterController",controllerAs:"registerVM"}).state("contactUs",{url:"/contact-us",templateUrl:"app/contactUs/contactUs.html",controller:"ContactUsController",controllerAs:"vm"}).state("requestLucaDemo",{url:"/request-accounting-demo",templateUrl:"app/product/requestLucaDemo.html",controller:"RequestLucaDemoController",controllerAs:"vm"}).state("/page-not-found",{template:"<h1>Page not found</h1>"})}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=routing,routing.$inject=["$stateProvider","$urlRouterProvider","$locationProvider"];

},{}],14:[function(require,module,exports){
"use strict";function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||!1,descriptor.configurable=!0,"value"in descriptor&&(descriptor.writable=!0),Object.defineProperty(target,descriptor.key,descriptor)}}return function(Constructor,protoProps,staticProps){return protoProps&&defineProperties(Constructor.prototype,protoProps),staticProps&&defineProperties(Constructor,staticProps),Constructor}}(),UserApi=function(){function UserApi(Api){_classCallCheck(this,UserApi),this.Api=Api,this.prefixUrl="/api/users"}return _createClass(UserApi,[{key:"login",value:function(data){return this.Api.post(this.prefixUrl+"/login",data)}},{key:"logout",value:function(){return this.Api.post(this.prefixUrl+"/logout")}},{key:"register",value:function(data){return this.Api.post(this.prefixUrl+"/register",data)}},{key:"isUniqueEmail",value:function(email){return this.Api.get(this.prefixUrl+"/is-unique-email/"+email)}},{key:"getByEmail",value:function(email){return this.Api.get(this.prefixUrl+"/by-email/"+email)}},{key:"getAuthReturnUrl",value:function(){return this.Api.get(this.prefixUrl+"/return-url")}}]),UserApi}();exports.default=UserApi,UserApi.$inject=["Api"];

},{}],15:[function(require,module,exports){
"use strict";function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||!1,descriptor.configurable=!0,"value"in descriptor&&(descriptor.writable=!0),Object.defineProperty(target,descriptor.key,descriptor)}}return function(Constructor,protoProps,staticProps){return protoProps&&defineProperties(Constructor.prototype,protoProps),staticProps&&defineProperties(Constructor,staticProps),Constructor}}(),LoginController=function(){function LoginController(userApi,setDirty,$rootScope,$scope,$state,$location,$window){_classCallCheck(this,LoginController),$rootScope.noFooter=!0,$scope.$on("$destroy",function(){$rootScope.noFooter=!1}),this.userApi=userApi,this.$rootScope=$rootScope,this.$state=$state,this.setDirty=setDirty,this.isError=!1,this.user={email:"",password:""},this.$window=$window,this.returnUrl=$location.search().returnUrl}return _createClass(LoginController,[{key:"login",value:function(form){var _this=this;if(form.$invalid)return this.setDirty(form);this.userApi.login(this.user).then(function(result){_this.returnUrl?_this.$window.location=_this.returnUrl:(_this.$rootScope.currentUser=result.returnValue.currentUser,_this.$state.go("home"))}).catch(function(err){return _this.isError=!0})}},{key:"loginByGoogle",value:function(){var url=this.$window.location.origin+"/auth/google";this.$window.open(url,"_self")}}]),LoginController}();exports.default=LoginController,LoginController.$inject=["userApi","setDirty","$rootScope","$scope","$state","$location","$window"];

},{}],16:[function(require,module,exports){
"use strict";function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||!1,descriptor.configurable=!0,"value"in descriptor&&(descriptor.writable=!0),Object.defineProperty(target,descriptor.key,descriptor)}}return function(Constructor,protoProps,staticProps){return protoProps&&defineProperties(Constructor.prototype,protoProps),staticProps&&defineProperties(Constructor,staticProps),Constructor}}(),RegisterController=function(){function RegisterController(userApi,setDirty,$rootScope,$scope,$state){_classCallCheck(this,RegisterController),$rootScope.noFooter=!0,$scope.$on("$destroy",function(){$rootScope.noFooter=!1}),this.userApi=userApi,this.$rootScope=$rootScope,this.$state=$state,this.setDirty=setDirty,this.isError=!1,this.user={email:"",password:""}}return _createClass(RegisterController,[{key:"check",value:function(form){var email=this.user.email;if(""===email)return!0;this.userApi.isUniqueEmail(email).then(function(isValid){isValid===!0?(form.email.$invalid=!0,form.email.$error.check=!0,form.email.$dirty=!0):(form.email.$error.check=!1,form.email.$dirty=!1,form.email.$invalid=!1)})}},{key:"register",value:function(form){var _this=this,user=this.user;return form.$invalid?this.setDirty(form):user.password!==user.confirm_password?(form.confirm_password.$error.match=!0,this.setDirty(form)):form.email.$error.check===!0?this.setDirty(form):void this.userApi.register(user).then(function(result){return _this.$state.go("home")})}}]),RegisterController}();exports.default=RegisterController,RegisterController.$inject=["userApi","setDirty","$rootScope","$scope","$state"];
...
"use strict";function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var HomeController=function HomeController(){_classCallCheck(this,HomeController),this.prices=[{name:"رایگان",cost:"۰ هزار تومان",features:["تک کاربره","امنیت پایین","نسخه پشتیبان ندارد","حد اکثر 1000 سند حسابداری"]},{name:"اقتصادی",cost:"50.000 تومان (ماهیانه)",features:["2 کاربره","امنیت بالاتر نسبت به طرح رایگان","نسخه پشتبان هر 24 ساعت","حجم دیتابیس 500 مگابایت"]},{name:"حرفه ای",cost:"200.000 تومان (ماهیانه)",features:["5 کاربره","رمز نگاری از اطلاعات حساس","نسخه پشتبان هر 12 ساعت ","حجم دیتابیس 2 گیگابایت"]},{name:"سرور اختصاصی ",cost:"تماس بگیرید",features:["دامین اختصاصی","کابران نامحدود","حجم دیتابیس نامحدود","نسخه پشتبان هر 12 ساعت "]}]};exports.default=HomeController;

},{}],19:[function(require,module,exports){
"use strict";function shell($mdSidenav,$rootScope,$window){return{restrict:"E",templateUrl:"app/layout/shell.html",link:function(scope,element,attrs){scope.openMenu=function(){return $mdSidenav("right").toggle()};var currentUser=$window.document.getElementsByName("currentUser")[0].content;currentUser?(scope.currentUser=currentUser,scope.currentUserImage=$window.document.getElementsByName("currentUserImage")[0].content,scope.logined=!0):(currentUser=$rootScope.currentUser)&&(scope.currentUser=currentUser,scope.logined=!0)}}}Object.defineProperty(exports,"__esModule",{value:!0}),shell.$inject=["$mdSidenav","$rootScope","$window"],exports.default=shell;

},{}],20:[function(require,module,exports){
"use strict";function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var AboutUSController=function AboutUSController(){_classCallCheck(this,AboutUSController),this.teams=[{name:"امین شیخی",img:"/img/persons/Amin_Sheikhi.jpg",position:"بنیانگذار و مدیر فنی",degree:"مهندسی IT گرایش تجارت الکترونیک",desc:"با سابقه ی 7سال در زمینه نرم افزارهای مالی و حسابداری، پیشرو و بروز در زمینه ی تکنولوژی های نرم افزاری",linkedin:"https://www.linkedin.com/in/amin-sheikhi-29833050/"},{name:"ساناز سلیمانی",img:"/img/persons/SanazSoleimani.jpg",position:"بنیانگذار و مدیر محصول",degree:"مهندسی نرم افزار",desc:"با سابقه ی 2 سال در زمینه ی نرم افزارهای مالی و حسابداری، همچنین 3سال متخصص در زمینه ی هوش تجاری، گزارشات و داشبورد در صنعت بیمه",linkedin:"https://www.linkedin.com/in/sanaz-soleimani-b37616ab/"},{name:"علیرضا آقازاده",img:"/img/persons/alireza.jpg",position:"مشاور مالی نرم افزار",degree:"کارشناسی مالی و حسابداری",desc:"مدیر مالی چندین شرکت معتبر در صنعت برق بوده و اکنون مشاور مالی  چندین شرکت می باشد.",linkedin:""},{name:"آذین امینی",img:"/img/persons/Azin_Amini.jpg",position:"کارشناس تست نرم افزار",degree:"مهندسی شیمی",desc:"با سابقه ی تدریس و کمک حسابداری در شرکت مالی و حسابداری",linkedin:""}]};exports.default=AboutUSController;

},{}],21:[function(require,module,exports){
"use strict";function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var PricingController=function PricingController($stateParams,$sce){_classCallCheck(this,PricingController);var products={luca:{name:"نرم‌افزار حسابداری آنلاین لوکا",title:"لوکا",logo:"/img/loka.png",description:$sce.trustAsHtml("هدف ما در اختیار قرار دادن امکاناتی درخور و شایسته شما با کمترین هزینه می‌باشد. ما می خواهم شما با هر توان مالی در کنار ما براحتی به اهداف مالی خود دست یابید و بتوانید بهترین کاربرد را از اطلاعات خود داشته باشید.<br>اینگونه بودن در کنار هم هنر است."),prices:[{name:"رایگان",cost:"۰",features:["تک کاربره","امنیت پایین","نسخه پشتیبان ندارد","ماهیانه ۵۰ سند حسابداری"],color:"lime"},{name:"اقتصادی",cost:"50.000 تومان / ماهیانه",features:["2 کاربره","امنیت بالاتر نسبت به طرح رایگان","نسخه پشتبان هر 24 ساعت","حجم دیتابیس 500 مگابایت"],color:"green"},{name:"حرفه ای",cost:"200.000 تومان / ماهیانه",features:["5 کاربره","رمز نگاری از اطلاعات حساس","نسخه پشتبان هر 12 ساعت ","حجم دیتابیس 2 گیگابایت"],color:"cyan"},{name:"سرور اختصاصی ",cost:"تماس بگیرید",features:["دامین اختصاصی","کابران نامحدود","حجم دیتابیس نامحدود","نسخه پشتبان هر 12 ساعت "],color:"blue"}]}},TYPE=$stateParams.type;this.product=products[TYPE]};exports.default=PricingController,PricingController.$inject=["$stateParams","$sce"];
