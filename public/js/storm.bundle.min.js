...
},{"dropzone":12}],32:[function(require,module,exports){
"use strict";function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||!1,descriptor.configurable=!0,"value"in descriptor&&(descriptor.writable=!0),Object.defineProperty(target,descriptor.key,descriptor)}}return function(Constructor,protoProps,staticProps){return protoProps&&defineProperties(Constructor.prototype,protoProps),staticProps&&defineProperties(Constructor,staticProps),Constructor}}(),SetupFirstPeriodController=function(){function SetupFirstPeriodController(fiscalPeriodApi,$state,setDirty){_classCallCheck(this,SetupFirstPeriodController),this.fiscalPeriodApi=fiscalPeriodApi,this.$state=$state,this.setDirty=setDirty,this.fiscalPeriod={minDate:"",maxDate:""}}return _createClass(SetupFirstPeriodController,[{key:"save",value:function(form){var _this=this;if(form.$invalid)return this.setDirty(form);this.fiscalPeriodApi.create(this.fiscalPeriod).then(function(){_this.$state.go("^.chartOfAccount")})}}]),SetupFirstPeriodController}();exports.default=SetupFirstPeriodController,SetupFirstPeriodController.$inject=["fiscalPeriodApi","$state","setDirty"];

},{}],33:[function(require,module,exports){
"use strict";function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||!1,descriptor.configurable=!0,"value"in descriptor&&(descriptor.writable=!0),Object.defineProperty(target,descriptor.key,descriptor)}}return function(Constructor,protoProps,staticProps){return protoProps&&defineProperties(Constructor.prototype,protoProps),staticProps&&defineProperties(Constructor,staticProps),Constructor}}(),SetupInfoController=function(){function SetupInfoController(branchApi,setDirty,$state){_classCallCheck(this,SetupInfoController),this.branchApi=branchApi,this.setDirty=setDirty,this.$state=$state,this.isWaiting=!1,this.branch={name:"",logo:"",phone:"",address:"",registrationNumber:""}}return _createClass(SetupInfoController,[{key:"save",value:function(form){var _this=this;if(form.$invalid)return this.setDirty(form);this.isWaiting=!0,this.branchApi.create(this.branch).then(function(result){_this.$state.go("^.firstPeriod")}).finally(function(){return _this.isWaiting=!1})}},{key:"logoUploaded",value:function(fileName){this.branch.logo=fileName}}]),SetupInfoController}();exports.default=SetupInfoController,SetupInfoController.$inject=["branchApi","setDirty","$state"];
...
"use strict";function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var ProfileController=function ProfileController(){_classCallCheck(this,ProfileController)};exports.default=ProfileController;
...
},{"sweetalert":21}],43:[function(require,module,exports){
